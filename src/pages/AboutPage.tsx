    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-black p-8 rounded-lg border border-gray-800 shadow-md mb-16">
        ...
        <p className="text-gray-400 mb-6">
          At StockPred, we're dedicated to democratizing stock market prediction through advanced machine learning algorithms and real-time data analysis. Our platform provides investors with powerful tools to make informed decisions based on historical trends and predictive models.
        </p>
        <p className="text-gray-400 mb-6">
          Founded in 2024 December by the best three students, StockPred focuses specifically on the Indian stock market, offering comprehensive analysis of NSE and BSE listed companies. We combine cutting-edge technology with financial expertise to deliver accurate predictions and insights.
        </p>
        ...
        <div className="mt-8">
          ...
          <ul className="space-y-2 text-gray-400">
            <li className="flex items-start space-x-2">
              <span><strong className="text-white">Linear Regression:</strong> Simple yet effective for stable market conditions and long-term trends</span>
            </li>
            <li className="flex items-start space-x-2">
              <span><strong className="text-white">Moving Average:</strong> Reduces noise in volatile markets for clearer trend identification</span>
            </li>
            <li className="flex items-start space-x-2">
              <span><strong className="text-white">Random Forest:</strong> Advanced machine learning for multi-factor analysis and higher accuracy</span>
            </li>
          </ul>
          <p className="text-gray-400 mt-4">
            We continuously refine our models based on performance and market conditions to ensure the highest possible prediction accuracy.
          </p>
        </div>
      </div>
      ...
      <div className="bg-black p-8 rounded-lg border border-gray-800 shadow-md text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <a 
            href="mailto:contact@stockpred.com" 
          ...
          <a 
            href="https://github.com/igneelsane" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center space-x-2 bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-md transition-colors"
          >
          ...
          <a 
            href="https://stockpred.com" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center space-x-2 bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-md transition-colors"
          >
            <Globe size={18} />
            <span>www.stockpred.com</span>
          </a>
        </div>
      </div>
    </div>
